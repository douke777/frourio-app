...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  return {
    ...
    profiles: {
      get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_1qj5k18['get']['resBody']>(prefix, PATH11, GET, option).json(),
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_1qj5k18['get']['resBody']>(prefix, PATH11, GET, option).json().then(r => r.body),
    ...
    users: {
      ...
      get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_1xhiioa['get']['resBody']>(prefix, PATH12, GET, option).text(),
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_1xhiioa['get']['resBody']>(prefix, PATH12, GET, option).text().then(r => r.body),
      $path: () => `${prefix}${PATH12}`,
    },
    get: (option?: { config?: T | undefined } | undefined) =>
